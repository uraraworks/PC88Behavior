...
- `ext1-rom-bank-preregistration.md` — ext1 — 拡張ROMバンクの読み分け・欠落・割り込み安全性・中継費用 — 事前登録、測定前。配置案C選択を受け、自作試験ROM（識別パターン入りN88_0〜3.ROM＋中継ルーチン）だけでQ1〜Q4を確かめる。8腕×2走、陽性/陰性対照・故障注入・G1〜G6
