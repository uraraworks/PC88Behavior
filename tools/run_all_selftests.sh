...
SCRIPTS_EXPECTED=(
  ...
  "tools/analyze_m6ib_first_request_selftest.sh:0"
  "tools/judge_m6ib_first_request_selftest.sh:0"
  "tools/check_m6ib_rom_gate_selftest.sh:0"
  "tools/check_m6ic_rom_gate_selftest.sh:0"
  "tools/check_m6ib_preregistration_selftest.sh:0"
  "tools/check_m6ic_preregistration_selftest.sh:0"
  "tools/analyze_m6ic_selftest.sh:0"
  "tools/judge_m6ic_selftest.sh:0"
  ...
  "tools/check_m6ig_rom_gate_selftest.sh:0"
  "tools/check_m6ig_preregistration_selftest.sh:0"
  ...
  # m6i-i一般READの生成像・独立D88読取器・既存SHA、および実Z80上の
